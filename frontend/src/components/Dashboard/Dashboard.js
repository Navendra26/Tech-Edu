...
const Dashboard = () => {
  ...
  const onTopToggled = () => {
    if (
      ...
      setStyle(
        "navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled-top"
      );
    } else {
      setStyle("navbar-nav bg-gradient-primary sidebar sidebar-dark accordion");
    }
    ...
    <div>
      <body id="page-top">
        ...
        <div id="wrapper">
          ...
          <ul className={style} id="accordionSidebar">
            ...
            >
              ...
              <div className="sidebar-brand-text mx-3">Technical Edu</div>
            </a>
       ...
       <div className="text-center">
         ...
         <Button href="contents/createcontent" >Create a new content</Button>
       </div>
       {/* <!-- Logout Modal--> */}
        {/* 
        <div
